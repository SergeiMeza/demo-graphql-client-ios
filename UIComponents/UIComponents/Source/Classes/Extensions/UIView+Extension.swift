...
extension UIView {
  ...
  @discardableResult
  public func setHugging(priority: UILayoutPriority, for axis: NSLayoutConstraint.Axis) -> UIView {
    setContentHuggingPriority(priority, for: axis)
    return self
  }
  
  @discardableResult
  public func setCompressionResistance(priority: UILayoutPriority, for axis: NSLayoutConstraint.Axis) -> UIView {
...
extension UIView {
  @discardableResult
  public func horizontal(_ type: DividerType) -> UIView {
    switch type {
    case .extraSmall:
      setWidth(6)
    case .small:
  ...
  @discardableResult
  public func vertical(_ type: DividerType) -> UIView {
    switch type {
    case .extraSmall:
      setHeight(6)
    case .small:
...
extension UIView {
  @discardableResult
  open func addTo(view: UIView) -> UIView {
    view.addSubview(self)
    return self
  }
  
  @discardableResult
  open func clipsToBounds(_ clip: Bool) -> UIView {
    self.clipsToBounds = clip
    return self
  }
  
  @discardableResult
  open func maskedCorners(_ maskedCorners: CACornerMask) -> UIView {
    self.layer.maskedCorners = maskedCorners
    return self
  }
  
  @discardableResult
  open func interactive(_ interactive: Bool) -> UIView {
...
extension UIView {
  @discardableResult
  open func onTap(action: @escaping () -> (), disposeBag: DisposeBag) -> UIView {
...
extension UIView {
  @discardableResult
  open func makeConstraints(_ maker: (ConstraintMaker) -> ()) -> UIView {
    self.snp.makeConstraints(maker)
    return self
  }
  
  @discardableResult
  open func updateConstraints(_ maker: (ConstraintMaker) -> ()) -> UIView {
