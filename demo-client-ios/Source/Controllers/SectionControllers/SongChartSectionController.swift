...
class SongChartSectionController: ListBindingSectionController<AppleMusicAPIClient.SongChart>, ListBindingSectionControllerDataSource {
  ...
  func sectionController(_ sectionController: ListBindingSectionController<ListDiffable>, viewModelsFor object: Any) -> [ListDiffable] {
    guard let object = object as? AppleMusicAPIClient.SongChart else { fatalError() }
    return object.songs
  }
...
extension SongChartSectionController: SongPreviewCellDelegate {
