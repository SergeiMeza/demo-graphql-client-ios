...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// Image `eriko`.
    static let eriko = Rswift.ImageResource(bundle: R.hostingBundle, name: "eriko")
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "eriko", bundle: ..., traitCollection: ...)`
    static func eriko(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.eriko, compatibleWith: traitCollection)
    }
    #endif
